...
module Autobot::Channels
  ...
  class TelegramChannel < Channel
    ...
    private def parse_script_args(args_str : String) : Array(String)
      ...
      args = [] of String
      # Optimization: Use IO::Memory instead of string concatenation (+=) in a loop
      # This significantly reduces memory allocations and improves performance
      # when parsing arguments, avoiding O(N^2) string building overhead.

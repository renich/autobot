...
module Autobot::Channels
  ...
  class TelegramChannel < Channel
    ...
    # ⚡ Bolt: Use IO::Memory instead of string concatenation inside loop
    # String concatenation (`+=`) allocates a new string for each character, which is slow.
    # IO::Memory builds the string incrementally and converts to string only when needed.

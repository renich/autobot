...
module Autobot::Channels
  ...
  class TelegramChannel < Channel
    ...
    # ⚡ Bolt: Optimize string concatenation inside loops
    # Prefer `IO::Memory` over string concatenation (`+=`) inside loops to significantly
    # improve performance and reduce memory allocations in Crystal.
